...
6. **Staffing requirements:** set the RN minimum to 11 for 21 September, Day. Show the before/after comparison. These browser planning floors do not currently change the live decision engine.
